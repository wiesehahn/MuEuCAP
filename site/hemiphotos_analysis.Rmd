...
knitr::include_graphics("https://github.com/wiesehahn/MuEuCAP/blob/master/raw_data/img/MDLDT04_1_xmp_e.jpg?raw=true")
```


### after {-}
```{r, out.width = "100%", fig.cap="Binary Black and White Image after processing"}
knitr::include_graphics("https://github.com/wiesehahn/MuEuCAP/blob/master/output_data/img/MDLDT04_1_xmp_e_T.jpg?raw=true")
```
